      ...
      >
        ...
        <CardDeck>
          <Card>
            ...
            <Card.Body>
              <Card.Title>Team Sports Starter: Hockey</Card.Title>
              <Card.Text>
          ...
          <Card>
            ...
            <br/>
            <br/>
              <Card.Title>United States of America Starter: The American Flag</Card.Title>
              <Card.Text>
          ...
          <Card>
            ...
            <Card.Body>
              <Card.Title>12 Natural Wonders of the World Starter: Milky Way</Card.Title>
              <Card.Text>
        ...
        <Row>
         <CardDeck>
          <Card>
            ...
            <Card.Body>
              <Card.Title>Endangered Species Starter: Asian Elephant</Card.Title>
              <Card.Text>
          ...
          <Card>
            ...
            <Card.Body>
              ...
              <Card.Title>Carnivorous Dinosaurs Starter: Giganotosaurus</Card.Title>
              <Card.Text>
          ...
          <Card>
            ...
            <Card.Body>
              <Card.Title>Ocean Life Starter: Manatee</Card.Title>
              <Card.Text>
